...
# The parameter adjust is a multiplicate bandwidth adjustment. This help us to adjust the bandwidth. For example, adjust = 1/3 means use one third of the default bandwidth.
